...
class Player(BasePlayer):
    Backtesting = models.IntegerField(label='Please specify the resulting volatility (in %; careful: if your answer is x % you insert "x" in the field!). ')
